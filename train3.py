...
def trans_image(image, angle, translation_range, correction=0.04):
    horizontal_shift = translation_range * uniform(-1, 1)
    new_angle = angle + correction * horizontal_shift / translation_range
...
def shadow(image):
    ...
    hlsed[:, :, 1][to_be_shadowed] = hlsed[:, :, 1][to_be_shadowed] * numpy.random.uniform(0.3, 0.5)
...
# directories = ['track2', 'track3', 'track4', 'track5', 'track6']
# directories = ['track2', 'track3', 'track4', 'track5', 'track7']
directories = ['track2', 'track3', 'track4', 'track5']
# directories = ['track2', 'track3', 'track4', 'track5', 'shaded_sharp_hill']
# directories = ['track7']
